...
public class Spng {
    ...
    public static final int
        ...
        SPNG_SPNG_EINVAL                   = 1,
        SPNG_SPNG_EMEM                     = 2,
        SPNG_SPNG_EOVERFLOW                = 3,
        SPNG_SPNG_ESIGNATURE               = 4,
        SPNG_SPNG_EWIDTH                   = 5,
        SPNG_SPNG_EHEIGHT                  = 6,
        SPNG_SPNG_EUSER_WIDTH              = 7,
        SPNG_SPNG_EUSER_HEIGHT             = 8,
        SPNG_SPNG_EBIT_DEPTH               = 9,
        SPNG_SPNG_ECOLOR_TYPE              = 10,
        SPNG_SPNG_ECOMPRESSION_METHOD      = 11,
        SPNG_SPNG_EFILTER_METHOD           = 12,
        SPNG_SPNG_EINTERLACE_METHOD        = 13,
        SPNG_SPNG_EIHDR_SIZE               = 14,
        SPNG_SPNG_ENOIHDR                  = 15,
        SPNG_SPNG_ECHUNK_POS               = 16,
        SPNG_SPNG_ECHUNK_SIZE              = 17,
        SPNG_SPNG_ECHUNK_CRC               = 18,
        SPNG_SPNG_ECHUNK_TYPE              = 19,
        SPNG_SPNG_ECHUNK_UNKNOWN_CRITICAL  = 20,
        SPNG_SPNG_EDUP_PLTE                = 21,
        SPNG_SPNG_EDUP_CHRM                = 22,
        SPNG_SPNG_EDUP_GAMA                = 23,
        SPNG_SPNG_EDUP_ICCP                = 24,
        SPNG_SPNG_EDUP_SBIT                = 25,
        SPNG_SPNG_EDUP_SRGB                = 26,
        SPNG_SPNG_EDUP_BKGD                = 27,
        SPNG_SPNG_EDUP_HIST                = 28,
        SPNG_SPNG_EDUP_TRNS                = 29,
        SPNG_SPNG_EDUP_PHYS                = 30,
        SPNG_SPNG_EDUP_TIME                = 31,
        SPNG_SPNG_EDUP_OFFS                = 32,
        SPNG_SPNG_EDUP_EXIF                = 33,
        SPNG_SPNG_ECHRM                    = 34,
        SPNG_SPNG_EPLTE_IDX                = 35,
        SPNG_SPNG_ETRNS_COLOR_TYPE         = 36,
        SPNG_SPNG_ETRNS_NO_PLTE            = 37,
        SPNG_SPNG_EGAMA                    = 38,
        SPNG_SPNG_EICCP_NAME               = 39,
        SPNG_SPNG_EICCP_COMPRESSION_METHOD = 40,
        SPNG_SPNG_ESBIT                    = 41,
        SPNG_SPNG_ESRGB                    = 42,
        SPNG_SPNG_ETEXT                    = 43,
        SPNG_SPNG_ETEXT_KEYWORD            = 44,
        SPNG_SPNG_EZTXT                    = 45,
        SPNG_SPNG_EZTXT_COMPRESSION_METHOD = 46,
        SPNG_SPNG_EITXT                    = 47,
        SPNG_SPNG_EITXT_COMPRESSION_FLAG   = 48,
        SPNG_SPNG_EITXT_COMPRESSION_METHOD = 49,
        SPNG_SPNG_EITXT_LANG_TAG           = 50,
        SPNG_SPNG_EITXT_TRANSLATED_KEY     = 51,
        SPNG_SPNG_EBKGD_NO_PLTE            = 52,
        SPNG_SPNG_EBKGD_PLTE_IDX           = 53,
        SPNG_SPNG_EHIST_NO_PLTE            = 54,
        SPNG_SPNG_EPHYS                    = 55,
        SPNG_SPNG_ESPLT_NAME               = 56,
        SPNG_SPNG_ESPLT_DUP_NAME           = 57,
        SPNG_SPNG_ESPLT_DEPTH              = 58,
        SPNG_SPNG_ETIME                    = 59,
        SPNG_SPNG_EOFFS                    = 60,
        SPNG_SPNG_EEXIF                    = 61,
        SPNG_SPNG_EIDAT_TOO_SHORT          = 62,
        SPNG_SPNG_EIDAT_STREAM             = 63,
        SPNG_SPNG_EZLIB                    = 64,
        SPNG_SPNG_EFILTER                  = 65,
        SPNG_SPNG_EBUFSIZ                  = 66,
        SPNG_SPNG_EIO                      = 67,
        SPNG_SPNG_EOF                      = 68,
        SPNG_SPNG_EBUF_SET                 = 69,
        SPNG_SPNG_EBADSTATE                = 70,
        SPNG_SPNG_EFMT                     = 71,
        SPNG_SPNG_EFLAGS                   = 72,
        SPNG_SPNG_ECHUNKAVAIL              = 73,
        SPNG_SPNG_ENCODE_ONLY              = 74,
        SPNG_SPNG_EOI                      = 75,
        SPNG_SPNG_ENOPLTE                  = 76,
        SPNG_SPNG_ECHUNK_LIMITS            = 77,
        SPNG_SPNG_EZLIB_INIT               = 78,
        SPNG_SPNG_ECHUNK_STDLEN            = 79,
        SPNG_SPNG_EINTERNAL                = 80,
        SPNG_SPNG_ECTXTYPE                 = 81,
        SPNG_SPNG_ENOSRC                   = 82,
        SPNG_SPNG_ENODST                   = 83,
        SPNG_SPNG_EOPSTATE                 = 84,
        SPNG_SPNG_ENOTFINAL                = 85;
    ...
    public static final int
        SPNG_SPNG_COLOR_TYPE_GRAYSCALE       = 0,
        SPNG_SPNG_COLOR_TYPE_TRUECOLOR       = 2,
        SPNG_SPNG_COLOR_TYPE_INDEXED         = 3,
        SPNG_SPNG_COLOR_TYPE_GRAYSCALE_ALPHA = 4,
        SPNG_SPNG_COLOR_TYPE_TRUECOLOR_ALPHA = 6;

    public static final int
        SPNG_SPNG_FILTER_NONE    = 0,
        SPNG_SPNG_FILTER_SUB     = 1,
        SPNG_SPNG_FILTER_UP      = 2,
        SPNG_SPNG_FILTER_AVERAGE = 3,
        SPNG_SPNG_FILTER_PAETH   = 4;

    public static final int
        SPNG_SPNG_DISABLE_FILTERING   = 0,
        SPNG_SPNG_FILTER_CHOICE_NONE  = 8,
        SPNG_SPNG_FILTER_CHOICE_SUB   = 16,
        SPNG_SPNG_FILTER_CHOICE_UP    = 32,
        SPNG_SPNG_FILTER_CHOICE_AVG   = 64,
        SPNG_SPNG_FILTER_CHOICE_PAETH = 128,
        SPNG_SPNG_FILTER_CHOICE_ALL   = (8|16|32|64|128);

    public static final int
        SPNG_SPNG_INTERLACE_NONE  = 0,
        SPNG_SPNG_INTERLACE_ADAM7 = 1;

    public static final int
        SPNG_SPNG_FMT_RGBA8  = 1,
        SPNG_SPNG_FMT_RGBA16 = 2,
        SPNG_SPNG_FMT_RGB8   = 4,
        SPNG_SPNG_FMT_GA8    = 16,
        SPNG_SPNG_FMT_GA16   = 32,
        SPNG_SPNG_FMT_G8     = 64,
        SPNG_SPNG_FMT_PNG    = 256,
        SPNG_SPNG_FMT_RAW    = 512;

    public static final int
        SPNG_SPNG_CTX_IGNORE_ADLER32 = 1,
        SPNG_SPNG_CTX_ENCODER        = 2;

    public static final int
        SPNG_SPNG_DECODE_USE_TRNS    = 1,
        SPNG_SPNG_DECODE_USE_GAMA    = 2,
        SPNG_SPNG_DECODE_USE_SBIT    = 8,
        SPNG_SPNG_DECODE_TRNS        = 1,
        SPNG_SPNG_DECODE_GAMMA       = 2,
        SPNG_SPNG_DECODE_PROGRESSIVE = 256;

    public static final int
        SPNG_SPNG_CRC_ERROR   = 0,
        SPNG_SPNG_CRC_DISCARD = 1,
        SPNG_SPNG_CRC_USE     = 2;

    public static final int
        SPNG_SPNG_ENCODE_PROGRESSIVE = 1,
        SPNG_SPNG_ENCODE_FINALIZE    = 2;

    public static final int
        SPNG_SPNG_AFTER_IHDR = 1,
        SPNG_SPNG_AFTER_PLTE = 2,
        SPNG_SPNG_AFTER_IDAT = 8;

    public static final int
        SPNG_SPNG_KEEP_UNKNOWN_CHUNKS       = 1,
        SPNG_SPNG_IMG_COMPRESSION_LEVEL     = 2,
        SPNG_SPNG_IMG_WINDOW_BITS           = 3,
        SPNG_SPNG_IMG_MEM_LEVEL             = 4,
        SPNG_SPNG_IMG_COMPRESSION_STRATEGY  = 5,
        SPNG_SPNG_TEXT_COMPRESSION_LEVEL    = 6,
        SPNG_SPNG_TEXT_WINDOW_BITS          = 7,
        SPNG_SPNG_TEXT_MEM_LEVEL            = 8,
        SPNG_SPNG_TEXT_COMPRESSION_STRATEGY = 9,
        SPNG_SPNG_FILTER_CHOICE             = 10,
        SPNG_SPNG_CHUNK_COUNT_LIMIT         = 11,
        SPNG_SPNG_ENCODE_TO_BUFFER          = 12;
